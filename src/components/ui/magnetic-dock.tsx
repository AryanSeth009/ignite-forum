...
function DockItem({
    ...
    return (
        ...
        >
            ...
            >
                {/* Icon */}
                <div className="flex h-[60%] w-[60%] items-center justify-center text-neutral-700 dark:text-white">
                    {item.icon}
                </div>
                ...
                {showLabels && isHovered && (
                    <motion.div
                        ...
                        className={cn(
                            ...
                            'backdrop-blur-sm',
                            'whitespace-nowrap text-sm font-medium text-neutral-800 dark:text-white',
                    ...
                    >
                        ...
                        <div
                            className={cn(
                                ...
                                'h-2 w-2 rotate-45',
                                'bg-white dark:bg-neutral-900/95',
                                'border-b border-r border-neutral-200 dark:border-white/10'
                            )}
                        />
                    </motion.div>
                )}
